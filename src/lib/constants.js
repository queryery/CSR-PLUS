(() => {
  ...
  CSRP.MAPS = [ "Mirage", "Inferno", "Nuke", "Dust2", "Ancient", "Anubis", "Vertigo", "Train", "Overpass", "Cobblestone" ];
  CSRP.DEFAULTS = {
    masterEnabled: true,
    autoMatch: true,
    autoInvite: true,
  ...
  CSRP.TIERS = {
    ...
    consistent: {
      label: "Consistent",
      cls: "csrp-t-consistent"
    },
    peak: {
      label: "Has peak games",
      cls: "csrp-t-peak"
    },
    cold: {
      label: "Tilted",
