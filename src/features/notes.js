/* CSR+ — player notes/tags + a slide-in profile panel with match-history
 * quick preview and a "view profile" link. */
(() => {
  'use strict';
  ...
  // ── compact click-anywhere popover (tags / notes / profile) ───────────
  let pop = null;
  function closePop() {
  ...
  // Open our custom CSR+ profile page in a new browser tab.
  ...
  // Render a small tag chip next to cards that have a saved tag.
  function tick() {
